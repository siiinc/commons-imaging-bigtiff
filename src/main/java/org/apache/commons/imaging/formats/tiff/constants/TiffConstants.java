...
public final class TiffConstants {
    ...
    public static final int TIFF_CLASSIC = 42;
    public static final int TIFF_BIGTIFF = 43;
    ...
    public static final int BIG_TIFF_HEADER_SIZE = 16;
    public static final int BIG_TIFF_DIRECTORY_HEADER_LENGTH = 8;
    public static final int BIG_TIFF_DIRECTORY_FOOTER_LENGTH = 8; //not sure about this one
    public static final int BIG_TIFF_ENTRY_LENGTH = 20;
    public static final int BIG_TIFF_ENTRY_MAX_VALUE_LENGTH = 8;
