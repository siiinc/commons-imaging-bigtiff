...
package com.maxar.rda.imaging.formats.jpeg.iptc;
...
public class IptcParser extends BinaryFileParser
{
    ...
    protected List<IptcBlock> parseAllBlocks(final byte[] bytes,
        ...
        try (InputStream bis = new ByteArrayInputStream(bytes)) {
            ...
            final byte[] idString = BinaryFunctions.readBytes("", bis,
            ...
            while (true) {
                ...
                try {
                    imageResourceBlockSignature = BinaryFunctions.read4Bytes("", bis,
                ...
                if (blockNameLength == 0) {
                    ...
                    try {
                        blockNameBytes = BinaryFunctions.readBytes("", bis, blockNameLength,
