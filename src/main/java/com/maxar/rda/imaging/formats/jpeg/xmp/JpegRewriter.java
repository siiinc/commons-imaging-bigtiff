 ...
 */
package com.maxar.rda.imaging.formats.jpeg.xmp;
...
public class JpegRewriter extends BinaryFileParser
{
    ...
    protected static class JFIFPieceSegment extends JFIFPiece {
        ...
        public boolean isExifSegment() {
            ...
            if (!BinaryFunctions.startsWith(segmentData, JpegConstants.EXIF_IDENTIFIER_CODE)) {
                return false;
            }
            return true;
        }
        ...
        public boolean isXmpSegment() {
            ...
            if (!BinaryFunctions.startsWith(segmentData, JpegConstants.XMP_IDENTIFIER)) {
                return false;
            }
            return true;
        }
