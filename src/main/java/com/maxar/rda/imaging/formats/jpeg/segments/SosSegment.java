...
public class SosSegment extends Segment {
    ...
    public SosSegment(final int marker, final int markerLength, final InputStream is) throws IOException {
        ...
        numberOfComponents = BinaryFunctions.readByte("number_of_components_in_scan", is,
        ...
        for (int i = 0; i < numberOfComponents; i++) {
            ...
            final int acDcEntropoyCodingTableSelector = BinaryFunctions.readByte(
        ...
        startOfSpectralSelection = BinaryFunctions.readByte("start_of_spectral_selection", is,
                "Not a Valid JPEG File");
        // Debug.debug("start_of_spectral_selection", startOfSpectralSelection);
        endOfSpectralSelection = BinaryFunctions.readByte("end_of_spectral_selection", is,
                "Not a Valid JPEG File");
        // Debug.debug("end_of_spectral_selection", endOfSpectralSelection);
        final int successiveApproximationBitPosition = BinaryFunctions.readByte(
