 ...
 */
package com.maxar.rda.imaging.formats.jpeg;

import static com.maxar.rda.imaging.common.BinaryFunctions.startsWith;

import com.maxar.rda.imaging.ImageFormat;
import com.maxar.rda.imaging.ImageFormats;
import com.maxar.rda.imaging.ImageInfo;
import com.maxar.rda.imaging.ImageParser;
...
import com.maxar.rda.imaging.formats.jpeg.decoder.JpegDecoder;
import com.maxar.rda.imaging.formats.jpeg.iptc.IptcParser;
import com.maxar.rda.imaging.formats.jpeg.iptc.PhotoshopApp13Data;
import com.maxar.rda.imaging.formats.jpeg.segments.App13Segment;
import com.maxar.rda.imaging.formats.jpeg.segments.App14Segment;
import com.maxar.rda.imaging.formats.jpeg.segments.App2Segment;
import com.maxar.rda.imaging.formats.jpeg.segments.ComSegment;
import com.maxar.rda.imaging.formats.jpeg.segments.DqtSegment;
import com.maxar.rda.imaging.formats.jpeg.segments.GenericSegment;
import com.maxar.rda.imaging.formats.jpeg.segments.JfifSegment;
import com.maxar.rda.imaging.formats.jpeg.segments.Segment;
import com.maxar.rda.imaging.formats.jpeg.segments.SofnSegment;
import com.maxar.rda.imaging.formats.jpeg.segments.UnknownSegment;
import com.maxar.rda.imaging.formats.jpeg.xmp.JpegXmpParser;
import com.maxar.rda.imaging.formats.tiff.TiffField;
import com.maxar.rda.imaging.formats.tiff.TiffImageMetadata;
import com.maxar.rda.imaging.formats.tiff.TiffImageParser;
...
public class JpegImageParser extends ImageParser
{
    ...
    public TiffImageMetadata getExifMetadata(final ByteSource byteSource, Map<String, Object> params)
        ...
        if (!params.containsKey(ImagingConstants.PARAM_KEY_READ_THUMBNAILS)) {
            params.put(ImagingConstants.PARAM_KEY_READ_THUMBNAILS, Boolean.TRUE);
        }
