...
import com.maxar.rda.imaging.common.ImageBuilder;
...
import com.maxar.rda.imaging.formats.tiff.constants.TiffEpTagConstants;
import com.maxar.rda.imaging.formats.tiff.constants.TiffTagConstants;
import com.maxar.rda.imaging.formats.tiff.datareaders.ImageDataReader;
import com.maxar.rda.imaging.formats.tiff.photometricinterpreters.PhotometricInterpreter;
import com.maxar.rda.imaging.formats.tiff.photometricinterpreters.PhotometricInterpreterBiLevel;
import com.maxar.rda.imaging.formats.tiff.photometricinterpreters.PhotometricInterpreterCieLab;
import com.maxar.rda.imaging.formats.tiff.photometricinterpreters.PhotometricInterpreterCmyk;
import com.maxar.rda.imaging.formats.tiff.photometricinterpreters.PhotometricInterpreterLogLuv;
import com.maxar.rda.imaging.formats.tiff.photometricinterpreters.PhotometricInterpreterPalette;
import com.maxar.rda.imaging.formats.tiff.photometricinterpreters.PhotometricInterpreterRgb;
import com.maxar.rda.imaging.formats.tiff.photometricinterpreters.PhotometricInterpreterYCbCr;
...
public class TiffImageParser extends ImageParser
{
    ...
    public ImageInfo getImageInfo(final ByteSource byteSource, final Map<String, Object> params)
        ...
        if (directory.findField(TiffTagConstants.TIFF_TAG_COMPRESSION) != null) {
            ...
            compressionFieldValue = TiffConstants.TIFF_COMPRESSION_UNCOMPRESSED_1;
        }
        final int compression = 0xffff & compressionFieldValue;
        ImageInfo.CompressionAlgorithm compressionAlgorithm;

        switch (compression) {
        case TiffConstants.TIFF_COMPRESSION_UNCOMPRESSED_1:
        ...
        case TiffConstants.TIFF_COMPRESSION_JPEG:
            ...
            break;
        case TiffConstants.TIFF_COMPRESSION_UNCOMPRESSED_2:
            compressionAlgorithm = ImageInfo.CompressionAlgorithm.NONE;
            break;
